...
- **`drop-in-examples/`** — example scenario drop-ins (`10-*.json`), each a JSON Patch array. Copy the ones you need into your own `genpolicy-settings.d/`. See [drop-in-examples/README.md](drop-in-examples/README.md). These examples are tested in Kata Containers CI.
